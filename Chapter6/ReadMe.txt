...
In addition, the file 'FederalistFreqFull.txt' contains 12 word-types with their absolute frequency in all articles in the Federalist papers corpus.  This file can be used to explore variants of the four machine learning strategies.  