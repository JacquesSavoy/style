...
tokenized.corpus <- txt.to.words.ext(raw.corpus, language="English", 
                                    preserve.case=FALSE)
# STEP 3: Subdive the corpus into differnet parts
...
# Number and  propostion of words appearing three times
sum(frequent.words.hamilton == 3)
sum(frequent.words.hamilton == 3) / voc.size.hamilton 
# Number and  propostion of words appearing five times of less
